                            ...
                            <div class="p-6">
                                ...
                                <form action="{{ route('welcome') }}" method="GET" class="flex flex-col md:flex-row gap-4">
                                    ...
                                    <div class="flex flex-col md:flex-row gap-2 items-end">
                                        <button type="submit" class="w-full md:w-auto flex px-4 py-2 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 whitespace-nowrap focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
