<nav x-data="{ open: false }" class="border-b border-gray-100" style="background-color: #f7f7f7;">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('supervised-users.index')" :active="request()->routeIs('supervised-users.*')">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->permissions->contains('name', 'create_user'))
            <x-responsive-nav-link :href="route('supervised-users.index')" :active="request()->routeIs('supervised-users.*')">
                {{ __('Usuarios Supervisados') }}
            </x-responsive-nav-link>
            @endif
